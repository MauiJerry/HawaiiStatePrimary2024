...
def estimate_table_size(contest, font_size=12, padding=2):
    ...
    total_width = sum(estimated_col_widths)
...
def generate_opendoc(contests):
    ...
    current_height = 0
    page_height_limit = 842 - 144  # Page height minus top and bottom margins (in points)

    for contest in contests:
        _, estimated_height = estimate_table_size(contest)
...
contests = [
    ...
    Contest("Contest 2", [Candidate("Candidate D", 500), Candidate("Candidate E", 300), Candidate("Candidate F", 100)],
            20, 3, 1),
    Contest("Contest 3", [Candidate("Candidate G", 450), Candidate("Candidate H", 250), Candidate("Candidate I", 200)],
            15, 4, 3),
    Contest("Contest 4", [Candidate("Candidate 9", 450), Candidate("Candidate hal", 250), Candidate("Candidate I", 200)],
            15, 4, 3),
    Contest("Contest 6", [Candidate("Candidate 10", 450), Candidate("Candidate george", 250), Candidate("Candidate I", 200)],
            15, 4, 3),
]
